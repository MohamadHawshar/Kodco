  ...
  return (
    ...
    flex-1 items-center sm:flex-row flex-col   
     `}>
      ...
      <div data-aos="slide-left" data-aos-duration="2000" className=' bg-center bg-fixed no-repeat bg-cover' id="clients">
      <h2 className={`${styles.flexCenter} ${styles.paddingY} font-semibold md:text-[50px] text-[35px]  `} >Nos Clients</h2>
    ...
    flex-1 items-center sm:flex-row flex-col flex-wrap justify-evenly pb-5`}>
        ...
        h-auto w-auto "
          >
            ...
            <img loading="lazy" data-aos="fade-in" data-aos-duration="4000" data-aos-anchor-placement="bottom-bottom" src={client.image} title={client.title}  alt={client.alt} 
            className={`${styles.flexCenter} sm:w-[150px] w-[90px] ${client.title == "ccq"? 'scale-150 ' : 'scale-100'} 
